...
--  ---------------------------------------------------------------------------
   ...
   function Cost (Pmap : in Path_Map; Loc : in Location_T) return Integer;

   function Terrain (Pmap : in Path_Map; Loc : in Location_T) return Terrain_T;

   procedure Mark_Adjacent (Pmap : in out Path_Map; Loc : in Location_T);
   procedure Mark_Near_Path (Pmap : in out Path_Map; Loc : in Location_T);
   procedure Mark_Path
   ...
   --  clear a loc and its surrounds from a path_map used in comp_move to keep
   --  from oscillating between the first two locs of a path map
   procedure Clear (Pmap : in out Path_Map; Loc : in Location_T);
...
--  ---------------------------------------------------------------------------
   ...
   type Path_Map is tagged record
      Map : Path_Map_Array;
   end record;
...
-- ---------------------------------------------------------------------------
   ...
   --  XXX XXX XXX these globals are used to cache current best objective XXX
   --  XXX XXX we need a way to pass this information around, as we XXX XXX XXX
   --  currently have a complex non-reentrant sequence of calls
