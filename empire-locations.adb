package body Empire.Locations is
   ...
   function Row_Col_Loc
     (Row : in Row_T;
      Col : in Column_T) return Location_T
   is
   begin
   ...
   function Row_Col_Sector
     (Row : in Row_T;
      Col : in Column_T) return Sector_T
   is
   begin
   ...
   begin
      return Row_Col_Loc
          (Sector_Row (Sec) * ROWS_PER_SECTOR + ROWS_PER_SECTOR / 2,
