...
private
   ...
   --  these arrays are actually too big -- unless all cities end up on one
   --  continent (!)
   ...
   --  XXX XXX this cries out for a record type to return from mark_cont and
   --  pass around
   Ncity  : Integer := 0;
   Nland  : Integer := 0;
   Nshore : Integer := 0;
...
--  static int xread (FILE *, void *, int); static int xwrite (FILE *, void *,
--  int);
